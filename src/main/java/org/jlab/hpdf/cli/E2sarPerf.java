...
public class E2sarPerf {
    ...
    public static void main(String args[]){
        ...
        options.addOption("src", true, "Event source (default 1234) [s]");
        options.addOption("dataid", true, "Data id (default 4321) [s]");
        options.addOption("threads", true, "number of receive threads (defaults to 1) [r]");
        options.addOption("sockets", true, "number of receive threads (defaults to 1) [r]");
        options.addOption("rate", true, "send rate in Gbps (defaults to 1.0)");
        ...
        options.addOption("ip",  true, "IP address (IPv4 or IPv6) from which sender sends from or on which receiver listens. Defaults to 127.0.0.1. [s,r]");
        options.addOption("port", true, "Starting UDP port number on which receiver listens. Defaults to 10000. [r] ");
        ...
        options.addOption("seq", false, "use sequential numbers as event numbers in Sync and LB messages instead of usec [s]");
        options.addOption("deq", true, "number of dequeue read threads in receiver (defaults to 1) [r]");
        options.addOption("cores", true, "optional list of cores to bind receiver threads to; number of threads is equal to the number of cores [r]");
        options.addOption("indirect", false, "use byte[] to send data instead of Direct ByteBuffer [s]");
        options.addOption("hostname", true, "hostname of reassembler. Default is 'E2sarPerfRecevr'[r]");
